...
cl /EHsc /I vendor\SDL2\include /Fo:build\ /Fe:build\salix.exe src\main.cpp vendor\SDL2\lib\x64\SDL2.lib vendor\SDL2\lib\x64\SDL2main.lib Shell32.lib /link /SUBSYSTEM:CONSOLE
