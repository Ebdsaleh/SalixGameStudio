...
cl /EHsc /std:c++17 /I vendor\SDL2\include /I vendor\SDL2_image\include /Fo:build\ /Fe:build\salix.exe src\main.cpp src\core\Engine.cpp src\core\SDLTimer.cpp src\core\ChronoTimer.cpp src\rendering\SDLRenderer.cpp src\states\GameState.cpp src\states\LaunchState.cpp src\states\EditorState.cpp src\states\OptionsMenuState.cpp src\rendering\SDLTexture.cpp src\ecs\Transform.cpp src\ecs\Sprite2D.cpp src\ecs\Scene.cpp src\assets\AssetManager.cpp src\math\Vector2.cpp src\math\Vector3.cpp src\math\Color.cpp src\management\ProjectManager.cpp src\management\Project.cpp src\management\SceneManager.cpp vendor\SDL2\lib\x64\SDL2.lib vendor\SDL2\lib\x64\SDL2main.lib vendor\SDL2_image\lib\x64\SDL2_image.lib Shell32.lib /link /SUBSYSTEM:CONSOLE
